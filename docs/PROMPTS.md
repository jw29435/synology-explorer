...
**Prompt 3b (echte Geräte, direkt nach Prompt 3):** beide Handys per USB an Windows, adb-Server unter Windows läuft, in WSL zeigt `adb devices` Samsung und OnePlus. Dann:
```
