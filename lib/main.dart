...
Future<void> main() async {
  ...
  // Gerätetests (tool/e2e/device.sh): Semantik-Baum dauerhaft an, damit
  // `uiautomator dump` Texte und Labels der Flutter-Widgets sieht.
  if (kDebugMode && const bool.fromEnvironment('E2E')) {
